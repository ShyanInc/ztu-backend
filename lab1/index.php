...
<body>
    ...
    <h1>Василенко Олександр, ІПЗк-23-1</h1>
    <?php
    ...
    $month_number = 1;
    $season = "Зима";
    if ($month_number > 2 && $month_number < 6) $season = "Весна";
    if ($month_number >= 6 && $month_number < 9) $season = "Літо";
    if ($month_number >= 9 && $month_number < 12) $season = "Осінь";

    if ($month_number < 1 && $month_number > 12) echo "Невірний місяць року";
    else echo $season;
    ?>
